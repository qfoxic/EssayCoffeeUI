...
urlpatterns = patterns('',
    ...
    url(r'^buy-custom-essay/$', StaticPageView.as_view(module_name='customer', template_name='custom-essays.html'),
                                              name='custom-essays'),
    ...
    url(r'^order-research-paper/$', StaticPageView.as_view(module_name='customer', template_name='research-papers.html'),
                                              name='research-papers'),
    url(r'^term-papers-for-sale/$', StaticPageView.as_view(module_name='customer', template_name='term-papers.html'),
                                              name='term-papers'),
    ...
    url(r'^order-essay/new/$', task_new, name='new-order'),
    url(r'^order-essay/(?P<pk>\d+)/$', task_details, name='order-id'),
    url(r'^order-essay/(?P<pk>\d+)/edit/$', task_update, name='order-id-edit'),
    url(r'^order-essay/(?P<pk>\d+)/buy/$', task_status, name='order-id-buy'),
    url(r'^order-essay/(?P<pk>\d+)/delete/$', task_rm, name='order-id-delete'),
