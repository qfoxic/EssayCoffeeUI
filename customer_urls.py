...
urlpatterns = patterns('',
    ...
    url(r'^cookie-policy/$', StaticPageView.as_view(module_name='customer', template_name='cookie-policy.html'),
                                              name='cookie-policy'),
    url(r'^social-responsibility-notice/$', StaticPageView.as_view(module_name='customer', template_name='social-responsibility-notice.html'),
                                              name='social-responsibility-notice'),
