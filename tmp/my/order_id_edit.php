						...
						<div class="tab-content">
							<!-- Begin Details Tab -->
  							<div class="tab-pane active" id="details">
  								<form class="form-horizontal edit-order" role="form">
  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Order</label>
										<div class="col-md-9 col-sm-9">
											<input type="text" class="form-control" value="4545454545">
										</div>
  									</div>

  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Topic</label>
										<div class="col-md-9 col-sm-9">
											<input type="text" class="form-control" value="sgsdgjosddgj">
										</div>
  									</div>

  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Type of assignment</label>
										<div class="col-md-9 col-sm-9">
											<select class="form-control">
												<option selected>Dissertation chapter - Introduction</option>
  									...
  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Urgency</label>
										<div class="col-md-9 col-sm-9">
											<input type="text" class="form-control" value="14 days">
										</div>
  									</div>

  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Writer level</label>
										<div class="col-md-9 col-sm-9">
											<input type="text" class="form-control" value="Master's">
										</div>
  									</div>

  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Style</label>
										<div class="col-md-9 col-sm-9">
											<select class="form-control">
  									...
  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Sources</label>
										<div class="col-md-9 col-sm-9">
  									...
  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Language</label>
										<div class="col-md-9 col-sm-9">
											<select class="form-control">
  									...
  									<div class="form-group">
										...
										<div class="col-md-9 col-sm-9">
											<textarea class="form-control" rows="3">sdflkslkflskkfjlksdmklmlsdmf</textarea>
										</div>
  									</div>

  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Added</label>
										<div class="col-md-9 col-sm-9">
  									...
  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Delivery</label>
										<div class="col-md-9 col-sm-9">
											<div class='date datetimepicker'>
												<input type='text' class="form-control" />
												<i class="fa fa-calendar"></i>
  									...
  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Spacing</label>
										<div class="col-md-9 col-sm-9">
											<input type="text" class="form-control" value="Single spaced">
										</div>
  									</div>

  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Page price</label>
										<div class="col-md-9 col-sm-9">
  									...
  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Pages</label>
										<div class="col-md-9 col-sm-9">
  									...
  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Additional services</label>
										<div class="col-md-9 col-sm-9">
											<input type="text" class="form-control" value="5">
										</div>
  									</div>
  									...
  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Discount</label>
										<div class="col-md-9 col-sm-9">
  									...
  									<div class="form-group">
										...
										<div class="col-md-9 col-sm-9">
											<input type="text" class="form-control" value="356$">
										</div>
  									</div>

  									<div class="form-group">
  										<label class="col-md-3 col-sm-3 control-label">Payment details</label>
										<div class="col-md-9 col-sm-9">
											
										</div>
  									</div>

  									<div class="form-group writer-id">
  										<label class="col-md-3 col-sm-3 control-label">Writer ID</label>
										<div class="col-md-9 col-sm-9">
											
										</div>
  									</div>

  									<div class="row text-left order-actions">
