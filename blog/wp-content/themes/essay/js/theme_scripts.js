$(document).ready(function() {
	...
	$('#main-navigation ul li.menu-item-has-children').addClass('dropdown');
	$('#main-navigation ul li.menu-item-has-children > a').addClass('dropdown-toggle').attr({
		'data-toggle' : 'dropdown',
		'data-target' : '#',
		'href'        : '#'

	});
	$('#main-navigation .sub-menu').addClass('dropdown-menu').removeClass('sub-menu');
